...
class FavoriteFollowerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        favoriteViewModel.getALlFollowers(DetailFavoriteUser.id)
            .observe(viewLifecycleOwner) { follower ->
    ...
    private fun setFollowerData(listFollow: List<Follow>) {
        val adapter = FollowAdapter(emptyList(), listFollow, true)
        if (listFollow.isEmpty()) binding.emptyList.visibility = View.VISIBLE
